{ ... }:
{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      input = {
        kb_layout = "us,no";
        kb_options = "grp:alt_caps_toggle,altwin:swap_alt_win";
        ...
        mouse_refocus = 1;
        sensitivity = 1.0;
	accel_profile = "flat"; # Leave empty for libinput default
	#force_no_accel = "true"; # This is not recommended
        touchpad = {
          natural_scroll = true;
	  #disable_while_typeing = false; # Compatability with certain games
        };
      };
	...
	smart_resizing = 1;
      ...
      decoration = {
        ...
        blur = {
          enabled = true; # Disable this for battery saving
          size = 3;
          passes = 2;
          brightness = 1;
          contrast = 1.4;
      ...
      bind = [
        ...
        #",XF86AudioMute,exec, pamixer -t" # Mute volume
