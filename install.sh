...
print_header() {
    echo -E "$CYAN
       ...
       -"-"-----------------
                  ...
                  $BLUE https://github.com/Qwacktuz $RED 
...
install() {
    ...
    cp -r .assets/wallpapers/astronaut.png ~/Pictures/wallpapers
    cp -r .assets/wallpapers/gruvbox/* ~/Pictures/wallpapers/others/
    cp -r .assets/wallpapers/nixos/* ~/Pictures/wallpapers/others/
